...
const FAKE_RECIPES = [
  {
    ...
    uploader: {
      id: 'cmcj5bk810000iyc4kec7708r',
      firstName: 'Amara',
      lastName: 'Santos',
      email: 'amarasantos@example.com',
      profile: {
        bio: 'Food lover and home cook specializing in Filipino comfort dishes with a modern twist.',
      },
    },
  ...
  },
  {
    ...
    uploader: {
      id: 'cmcj5bklo0001iyc41o92e3d3',
      firstName: 'Liam',
      lastName: 'Delacruz',
      email: 'liamdelacruz@example.com',
      profile: {
        bio: 'Weekend chef and spice enthusiast who enjoys experimenting with Asian fusion cuisine.',
      },
    },
    slug: 'chicken-curry',
  },
  {
    ...
    uploader: {
      id: 'cmcj5bku50002iyc42slp08zj',
      firstName: 'Chloe',
      lastName: 'Tan',
      email: 'chloetan@example.com',
      profile: {
        bio: 'Baking is my therapy. Sharing my favorite dessert recipes one bite at a time.',
      },
    },
  ...
  },
  {
    ...
    uploader: {
      id: 'cmcj5bl2n0003iyc4r5gnq9m8',
      firstName: 'Diego',
      lastName: 'Ramirez',
      email: 'diegoramirez@example.com',
      profile: {
        bio: 'Self-taught cook passionate about quick, healthy meals for busy lifestyles.',
      },
    },
  ...
  },
  {
    ...
    uploader: {
      id: 'cmcj5blb40004iyc43nal9rcz',
      firstName: 'Isla',
      lastName: 'Fernandez',
      email: 'islafernandez@example.com',
      profile: {
        bio: 'Traveler turned foodie, collecting recipes and stories from every country I visit.',
      },
    },
    slug: 'caesar-salad',
  },
  {
    ...
    uploader: {
      id: 'cmcj5bljs0005iyc47r4fg5om',
      firstName: 'Noah',
      lastName: 'Reyes',
      email: 'noahreyes@example.com',
      profile: {
        bio: 'Simple ingredients, bold flavors. I believe good food brings people together.',
      },
    },
    slug: 'beef-tacos',
  },
